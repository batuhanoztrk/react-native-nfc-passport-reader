...
@available(iOS 13.0, *)
class PassportUtil: ObservableObject {
  @Published var passportNumber: String =
    UserDefaults.standard.string(forKey: "passportNumber") ?? ""
  ...
  func calcCheckSum(_ checkString: String) -> Int {
    let characterDict = [
      ...
      "9": "9", "<": "0", " ": "0", "A": "10", "B": "11", "C": "12", "D": "13", "E": "14",
...
extension String {
  func convertToYYMMDD() -> String? {
    let dateFormatter = DateFormatter()
    dateFormatter.dateFormat = "yyyy-MM-dd"

    if let date = dateFormatter.date(from: self) {
      let outputFormatter = DateFormatter()
      outputFormatter.dateFormat = "yyMMdd"
